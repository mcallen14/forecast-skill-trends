...
# def plot_basin_char_maps(ID_table, basin_char_columns, basin_char_names_display, folder_path):
#     """
#     Plot maps of 6 basin characteristics for 97 sites.

#     Parameters:
#     - ID_table (DataFrame): Contains site info and basin characteristics
#     - basin_char_columns (list): List of 6 basin characteristic column names
#     - basin_char_names_display (list): Display names for each basin characteristic
#     - folder_path (Path): Where to save the output figure
#     """
#     assert len(basin_char_columns) == 6 and len(basin_char_names_display) == 6
...
#     for i, (col, label) in enumerate(zip(basin_char_columns, basin_char_names_display)):
#         gdf_col = gdf.copy()
...
#         cmap = LinearSegmentedColormap.from_list("basin_cmap", ['navy', 'skyblue', 'gold', 'darkred'])
...
#     fig.suptitle('Basin Characteristics at 97 Sites', fontsize=18)
#     plt.tight_layout()
